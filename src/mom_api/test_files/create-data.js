 ...
 *
 * Changes in version 1.7 (FOUNDERSHARE (AKA PMP) - AUTHENTICATION AND SOCIAL MEDIA INTEGRATION ENHANCEMENT - 2):
 * - [PMP-237] Champion data added to business admins and Individual Users
 *
 * @version 1.7
 * @author TCSASSEMBLER
 */
            ...
            async.forEach(_.range(1, userCount + 1), function (nr, cb) {
                async.waterfall([
                    function (cb) {
                        ...
                        }, cb.wrap (function (champion) {
                            cb(null, user, champion);
                        }))
                    }, function (user, champion, cb) {
                        user.userRoles = [{
