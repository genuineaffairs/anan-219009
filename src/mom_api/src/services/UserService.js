 ...
 * - [PMP-237] Modified to match new champion schema
 *
 * @version 1.9
 * @author TCSASSEMBLER
 */
        ...
        {user: user},
        {
            user: {
                ...
                linkedSocialNetworks: {
                    type: [
                        {
                            socialUserId: "ShortString",
                            socialNetwork: "SocialNetwork",
                            accessToken: "ShortString"
                        }
                    ],
                    empty: true,
                    required: false
    ...
    var error = validate(
        {userId: userId, user: user},
        {
            ...
            user: {
                ...
                password: "ShortString?",
                subscribedToNews: "bool?",
                isStopVerificationReminder: "bool?",
                userRoles: {
                    type: [{
                        businessId: "ObjectId?",
                        championId: "ObjectId?",
...
function getBySocialNetwork(socialNetwork, linkedSocialNetworkUserId, callback) {
    ...
    User.findOne({
        linkedSocialNetworks: {
            $elemMatch: {
                socialUserId: linkedSocialNetworkUserId,
                socialNetwork: socialNetwork
            }
        }
    }, callback);
